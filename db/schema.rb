...
ActiveRecord::Schema.define(version: 2022_05_05_112351) do
  ...
  create_table "favorites", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "problem_id"], name: "index_favorites_on_user_id_and_problem_id", unique: true
  end
  ...
  create_table "questions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.integer "problem_id"
    t.index ["user_id", "problem_id"], name: "index_questions_on_user_id_and_problem_id", unique: true
  end
